<?php
	...
	if (function_exists('thematic_canonical_url')) thematic_canonical_url();
...
if (apply_filters('thematic_open_wrapper', true)) {
	...
	//appstage is the area on the homepage between the navigation and the content, where the main information about the app(s) is displayed
    ?>   
		<div id="app-stage">	
			<?php
				// calling the appstage.php
				get_template_part('appstage');
			?>
		</div>
    <div id="main">
